...
$('#cantidadApartamentos').numeric({negative: false, decimal: false});
...
$('#cantidadApartamentos-mod').numeric({negative: false, decimal: false});
...
$(document).on('click','#modEdificio', function(){
    ...
    .done(function(comp) {
        ...
        $("#cantidadApartamentos-mod").val(comp[0].cant_apart);
