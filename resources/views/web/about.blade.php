...
<html class="no-js" lang="zxx">
   ...
   <body class="body-bg">
    ...
    <main>
        ...
        <!-- Team End -->
        <!--? Testimonial Start -->
        <div class="testimonial-area testimonial-padding" data-background="{{ url('web/assets/img/gallery/section_bg04.jpg') }}">
            <div class="container ">
                                ...
                                <div class="testimonial-caption ">
                                    ...
                                    <div class="testimonial-founder d-flex align-items-center justify-content-center">
                                        <div class="founder-img">
                                            <img src="{{ url('assets/img/gallery/Homepage_testi.png') }}" alt="">
                                        </div>
