...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>Validación de corréo</title>
    ...
    <main>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <center>
                        <br><br>
                        <img src="{{ url('images/gif-carta.gif') }}" alt="Correo enviado" style="border: 10px solid #0d2d3e; border-radius:15px">
                        <br><br><br>
                    </center>
                </div>
                <div class="col-md-4">
                    <center>
                        <br><br>
                        <p>
                            Gracias por su afiliación a nuestro servicio, como ultimo paso queremos pedirle
                            que por favor valide el correo que acabamos de enviar a la cuenta descrita
                        </p>
                        <form method="POST" action="{{ route('verification.send') }}">
                            @csrf
                            <div>
                                <input type="submit" value="Reenviar verificación" class="btn btn-primary" style="background: #0d2d3e; color:white;">
                            </div>
                        </form>
                    <br><br><br><br>
                    </center>
